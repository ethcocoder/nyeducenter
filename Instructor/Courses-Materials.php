  ...
  <div class="main-content p-4">
    <div class="container-fluid d-flex justify-content-center">
      <div class="card bg-dark text-white shadow w-100" style="max-width: 900px;">
        <div class="card-body">
          <h4 class="mb-4">All Courses Materials (<?=$row_count?>) <a href="Courses-Materials-add.php" class="btn btn-primary">Upload Material</a></h4>
          ...
          <div class="d-flex justify-content-center mt-3 border border-secondary p-2 rounded">
              <?php
                    ...
                    if ($prev_btn){
                    ?>
                    <a href="Courses-Materials.php?page=<?=$prev?>" class="btn btn-secondary m-1">Prev</a>
                   <?php }else { ?>
                   ...
                   for($i = $push_mid; $i < 5 + $page; $i++){
                    if($i == $page){ ?>
                     <a href="Courses-Materials.php?page=<?=$i?>" class="btn btn-success m-1"><?=$i?></a>
                   <?php }else{ ?>
                     <a href="Courses-Materials.php?page=<?=$i?>" class="btn btn-secondary m-1"><?=$i?></a>
                   ...
                   if($last_page <= $i)break;
                    ...
                    if($next_btn){
                    ?>
                    <a href="Courses-Materials.php?page=<?=$next?>" class="btn btn-secondary m-1">Next</a>
                <?php }else { ?>
