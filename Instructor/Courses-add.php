...
<div class="wrapper">
  ...
  <div class="main-content p-4">
    <div class="container-fluid d-flex justify-content-center">
      <div class="card bg-dark text-white shadow w-100" style="max-width: 800px;">
        <div class="card-body">
          <!-- Form for creating a course -->
          <form id="courseForm" 
                action="/Instructor/Action/course-add.php"
                method="POST"
          ...
          <form id="Chapter" 
                ...
                method="POST">
              <h2 class="mb-4">Create a New Chapter</h2>
              <div class="mb-3">
          ...
          <form id="Topic" 
                ...
                method="POST">
              <h2 class="mb-4">Create a New Topic</h2>
              <div class="mb-3">
