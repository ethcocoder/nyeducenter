...
<div class="container my-4">
    <h2 class="mb-4">Innovator Dashboard</h2>
    <div class="alert alert-info">Welcome, <?= htmlspecialchars($currentUser['name']) ?>!</div>
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">My Innovations</h5>
                    <p class="display-5"> <?= $stats['my_innovations'] ?? 0 ?> </p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="row mb-4">
        <div class="col-md-4 mb-2">
            <a href="/innovations/create" class="btn btn-outline-primary w-100">Post Innovation</a>
        </div>
        <div class="col-md-4 mb-2">
            <a href="/my-innovations" class="btn btn-outline-success w-100">View My Innovations</a>
        </div>
        <div class="col-md-4 mb-2">
