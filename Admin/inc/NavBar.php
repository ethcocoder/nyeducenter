...
<div class="sidebar bg-dark text-white p-3">
    ...
    <ul class="nav flex-column mb-auto">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link btn btn-primary text-start text-white" href="Students.php">
                <i class="fa fa-user-graduate me-2"></i> Students
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link btn btn-primary text-start text-white" href="Instructors.php">
                <i class="fa fa-chalkboard-teacher me-2"></i> Instructors
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link btn btn-primary text-start text-white" href="Courses.php">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link btn btn-primary text-start text-white" href="Programs.php">
                <i class="fa fa-graduation-cap me-2"></i> Programs
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link btn btn-primary text-start text-white" href="System-Logs.php">
                <i class="fa fa-history me-2"></i> System Logs
            </a>
        </li>
        <li class="nav-item mb-2">
