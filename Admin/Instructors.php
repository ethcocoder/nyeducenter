        ...
        <div class="col-md-12">
          <div class="card bg-dark text-white shadow">
            <div class="card-header">
              <i class="fa fa-users" aria-hidden="true"></i> All Instructors (<?=$row_count?>)
              <a class="btn btn-success float-end" href="Instructor-add.php">Add Instructor</a>
            </div>
            <div class="card-body">
                      ...
                      <?php foreach ($instructors as $instructor) {?>
                        <tr>
                          ...
                          <td class="action_btn">
                            ...
                            $btn_class = $instructor["status"] == "Active" ? "btn-danger" : "btn-success";
                            ?>
