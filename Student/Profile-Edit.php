    ...
    <div class="container-fluid d-flex justify-content-center">
      <div class="card bg-dark text-white shadow w-100" style="max-width:700px;">
        <div class="card-body">
          ...
          <form style="max-width: 600px;" action="Action/upload-profile-details.php" method="POST">
            <div class="mb-3">
          ...
          <form id="ChangePassword" method="post" action="Action/change-password.php" style="max-width: 600px;">
            <div class="mb-3">
              <label class="form-label">Current password</label>
              <input type="password" placeholder="Current password" class="form-control" name="password">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="password" placeholder="Current password" class="form-control" id="confirmPassword" name="confirm_password">
            </div>
