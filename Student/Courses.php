...
<div class="wrapper">
  ...
  <div class="main-content p-4">
    <?php if ($courses) { ?>
    <h4 class="course-list-title mb-4">All Courses (<?=$row_count?>)</h4>
    <div class="row course-list">
      <?php foreach ($courses as $course) {?>
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card bg-dark text-white shadow h-100">
          <img src="../Upload/thumbnail/<?=$course["cover"]?>" class="card-img-top" alt="course" style="height:200px;object-fit:cover;">
